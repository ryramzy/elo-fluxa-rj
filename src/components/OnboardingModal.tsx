            ...
            <div className="py-4">
              <div className="space-y-4 mb-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">
                      Quando quiser mais, fale com o Professor
                    </h3>
                    <p className="text-slate-600">
                      Desbloqueie o curso completo conversando diretamente com o Professor no WhatsApp
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Pratique conversação com o Professor em sessões individuais personalizadas
                    </p>
                  </div>
                </div>
              </div>
