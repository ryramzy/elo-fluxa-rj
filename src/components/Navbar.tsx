            ...
            {!user ? (
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="text-xs font-black uppercase tracking-wider px-4 py-2.5 min-h-[38px] bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl transition-all shadow-md hidden sm:flex items-center justify-center border border-blue-400/40"
                >
                  ⚡ Testar Aula Grátis
                </button>
                <button 
                  ...
                  className="text-xs font-bold uppercase tracking-wider px-4 py-2.5 min-h-[38px] border border-slate-600 text-slate-200 hover:bg-slate-800 transition-all rounded-xl flex items-center justify-center"
                >
                  Entrar
                </button>
              </div>
