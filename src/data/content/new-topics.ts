export const newTopicsContent: Record<string, Record<string, { id: string; title: string; slides: string[] }>> = {
  "describe-it": {
    "desc-01": {
      id: "desc-01",
      title: "Describing Places & Atmosphere",
      slides: [
        "INTRO|||Painting with Words|||Welcome to Describe It! Today, we explore how to bring spaces to life using vivid adjectives.|||Elo: Hello! Are you ready to describe your surroundings today?",
        "VOCAB|||Atmospheric Adjectives|||Master these key terms to describe spaces:\n\n*   **Cozy / Snug** - Warm, comfortable, and inviting (e.g. 'a cozy cabin').\n*   **Cluttered** - Messy, filled with too many objects (e.g. 'a cluttered desk').\n*   **Spacious / Airy** - Having lots of space and fresh air (e.g. 'an airy loft').\n*   **Bustling** - Full of activity and noise (e.g. 'a bustling market').|||Elo: How would you describe your current room: cozy, cluttered, or spacious?",
        "CONCEPT|||Show, Don't Tell|||Instead of saying 'The room was nice,' describe specific sensory details (what you see, hear, or feel).\n\n*   **Example:** Instead of 'The cafe was good,' try: 'The cafe was filled with the rich aroma of roasted coffee and the soft hum of chatter.'\n\n> 💡 **Tutor Tip:** Sensory adjectives make your English sound 10x more natural and advanced!|||Elo: Try describing a rainy day using at least two sensory words.",
        "EXAMPLE|||Cozy Café Vibes|||A: How was the new bookstore? — B: It was so cozy. They had dim lighting, plush armchairs, and a soft crackling fireplace in the corner.|||Elo: Dim lighting and plush armchairs make it easy to visualize, right?",
        "CULTURE|||Cozy & 'Hyggelig'|||Americans love the concept of 'cozy' spaces, especially during winter. Starbucks and indie bookstores design their layouts specifically to feel like comfortable living rooms.|||Elo: What is your absolute favorite cozy spot?",
        ...
        "ROLEPLAY|||The Real Estate Agent|||You are showing a potential tenant a small but charming apartment. Make it sound appealing!\n\n*   **Goal:** Describe the space positively.\n*   **Target:** Use 'cozy', 'airy', or 'plush'.|||Elo: Welcome the client and describe the apartment's living room.",
        "REVIEW|||Vivid Space Descriptor|||You learned: Cozy, cluttered, airy, bustling, and the 'Show, Don't Tell' concept.|||Elo: Great job! You are ready to paint pictures with your words."
      ]
    },
    "desc-02": {
      id: "desc-02",
      ...
      slides: [
        "INTRO|||Beyond Appearance|||Let's learn how to describe personality traits, behaviors, and complex characters in English.|||Elo: How would your best friend describe your personality in three words?",
        "VOCAB|||Personality Traits|||Useful adjectives for describing people:\n\n*   **Easygoing** - Relaxed, tolerant, and not easily worried.\n*   **Witty** - Quick and inventive with verbal humor.\n*   **Reserved** - Slow to reveal emotions or opinions; quiet.\n*   **Driven** - Highly motivated, ambitious, and focused on success.|||Elo: Are you more easygoing or reserved in social settings?",
    ...
    "desc-03": {
      id: "desc-03",
      title: "Describing Food, Tastes & Textures",
      slides: [
        "INTRO|||Tasting the Language|||English food vocabulary goes far beyond 'delicious' and 'yummy.' Let's master tastes and textures.|||Elo: What is the most exotic food you have ever tasted?",
        "VOCAB|||Texture & Taste|||Key words for culinary descriptions:\n\n*   **Savory** - Salty or spicy, not sweet (e.g. 'a savory pie').\n*   **Crispy / Crunchy** - Firm and making a sharp sound when bitten.\n*   **Bland** - Lacking strong flavor; uninteresting.\n*   **Rich** - Heavy and filling, often with a lot of butter, cream, or chocolate.|||Elo: Do you prefer savory breakfasts or sweet ones?",
    ...
    "desc-04": {
      id: "desc-04",
      title: "Describing Emotions & Abstract Feelings",
      slides: [
        "INTRO|||The Landscape of Feeling|||Let's expand your emotional vocabulary to express complex feelings, stress, excitement, and peace.|||Elo: How are you feeling right now? Try to avoid using just 'fine' or 'okay'.",
        "VOCAB|||Emotional Adjectives|||Words for complex emotional states:\n\n*   **Anxious / Restless** - Uneasy, worried, or unable to relax.\n*   **Exhilarated** - Extremely happy, excited, and full of energy.\n*   **Overwhelmed** - Feeling like you have too much to handle.\n*   **Serene / Peaceful** - Calm, tranquil, and untroubled.|||Elo: When was the last time you felt completely exhilarated?",
  ...
  "friendship-social": {
    "frnd-01": {
      id: "frnd-01",
      title: "Making Small Talk & Breaking the Ice",
      slides: [
        "INTRO|||Breaking the Ice|||Small talk is the gateway to friendship. Today, we learn how to start conversations naturally.|||Elo: Do you find it easy to talk to strangers, or do you get nervous?",
        "VOCAB|||Icebreakers|||Phrases to kickstart a conversation:\n\n*   **Catch up** - To talk to someone you haven't seen in a while.\n*   **Hit it off** - To quickly become close friends upon meeting.\n*   **Break the ice** - To make people feel comfortable in a social situation.\n*   **Small talk** - Polite conversation about unimportant subjects.|||Elo: Have you ever 'hit it off' with someone immediately after meeting them?",
    ...
    "frnd-02": {
      id: "frnd-02",
      title: "Hosting Friends & Dinner Etiquette",
      slides: [
        "INTRO|||Welcome to My Home|||Hosting a dinner or gathering is a great way to deepen friendships. Let's learn hosting vocabulary.|||Elo: Do you prefer hosting dinner parties at home or eating out?",
        "VOCAB|||Hosting & Dining|||Key vocabulary for hosting friends:\n\n*   **Help yourself** - Serve yourself food or drink without waiting.\n*   **To host** - To receive guests in your home.\n*   **Potluck** - A gathering where each guest brings a dish to share.\n*   **BYOB** - Bring Your Own Beer/Beverage.|||Elo: Have you ever participated in an American-style 'potluck' dinner?",
    ...
    "frnd-03": {
      id: "frnd-03",
      title: "Deep Conversations & Sharing Personal Stories",
      slides: [
        "INTRO|||Beyond the Surface|||True friendship requires vulnerability. Let's learn to share stories and listen actively.|||Elo: What qualities do you value most in a close friend?",
        "VOCAB|||Vulnerability & Connection|||Words for deep conversations:\n\n*   **To open up** - To share personal feelings or secrets.\n*   **To relate to** - To understand or share feelings with someone.\n*   **Bond** - A strong connection between people.\n*   **To count on** - To rely on someone for support.|||Elo: Who is the one person you can always count on in a crisis?",
    ...
    "frnd-04": {
      id: "frnd-04",
      title: "Handling Conflicts & Giving Advice to Friends",
      slides: [
        "INTRO|||Tough Love|||Sustaining friendship means handling disagreements and giving constructive advice without breaking the bond.|||Elo: Have you ever had a serious disagreement with a close friend?",
        "VOCAB|||Conflict & Support|||Useful verbs for social resolution:\n\n*   **Talk it out** - Resolve a problem by talking about it.\n*   **Make up** - Re-establish friendly relations after an argument.\n*   **Clear the air** - Defuse tension by discussing differences.\n*   **Through thick and thin** - Support someone in good times and bad.|||Elo: Are you someone who likes to 'talk it out' immediately, or do you need space?",
  ...
  "getting-outside": {
    "out-01": {
      id: "out-01",
      title: "Hiking, Camping & Wilderness Safety",
      slides: [
        "INTRO|||Call of the Wild|||Welcome to Getting Outside! Today, we head into the mountains and forests to learn hiking and camping vocabulary.|||Elo: Do you enjoy hiking in nature, or do you prefer the city?",
        "VOCAB|||The Gear|||Essential outdoor vocabulary:\n\n*   **Trail** - A path through the countryside or forest.\n*   **Gear** - Equipment or clothing used for an activity (e.g. 'camping gear').\n*   **Trailhead** - The point where a trail begins.\n*   **Pitch a tent** - Set up a temporary shelter.|||Elo: Do you have your own camping gear, or would you need to rent it?",
    ...
    "out-02": {
      id: "out-02",
      title: "Beach Days, Surfing & Coastal English",
      slides: [
        "INTRO|||Sun, Sand & Surf|||Let's head to the coast! Learn the language of beach days, surfing, and enjoying the ocean.|||Elo: What is your favorite beach in the world?",
        "VOCAB|||Coastal Living|||Ocean and beach vocabulary:\n\n*   **Tide** - The alternate rising and falling of the sea (e.g. 'high tide').\n*   **Boardwalk** - A wooden path along a beach or waterfront.\n*   **Sunburn** - Redness of the skin caused by exposure to the sun.\n*   **Swell** - A series of ocean waves (important for surfers).|||Elo: Do you prefer relaxing on the sand or swimming in the ocean swell?",
    ...
    "out-03": {
      id: "out-03",
      title: "Explaining Nature, Weather & Seasons",
      slides: [
        "INTRO|||Forces of Nature|||Let's learn how to describe weather changes, changing seasons, and dramatic natural landscapes.|||Elo: What is your favorite season of the year, and why?",
        "VOCAB|||Seasons & Landscapes|||Words for natural phenomena:\n\n*   **Foliage** - Leaves on trees, especially during autumn.\n*   **Drizzle** - Light rain falling in very fine drops.\n*   **Breathtaking** - Astonishingly beautiful (e.g. 'a breathtaking view').\n*   **Overcast** - Dull and grey; covered with clouds.|||Elo: Do you prefer sunny skies or overcast, cozy days?",
    ...
    "out-04": {
      id: "out-04",
      title: "Discussing the Environment & Sustainability",
      slides: [
        "INTRO|||Protecting Our Planet|||Discussing environmental issues requires specific vocabulary. Let's learn about sustainability.|||Elo: What do you do in your daily life to practice sustainability?",
        "VOCAB|||Eco-friendly Terms|||Vocabulary for environmental discussions:\n\n*   **Carbon footprint** - The amount of carbon dioxide emitted due to your consumption.\n*   **Eco-friendly** - Not harmful to the environment.\n*   **Renewable** - Energy from source that is not depleted (e.g. solar/wind).\n*   **Biodegradable** - Capable of being decomposed by bacteria.|||Elo: Do you think eco-friendly products are too expensive?",
  ...
  "idioms-mastery": {
    "idm-01": {
      ...
      slides: [
        "INTRO|||Raining Cats and Dogs|||Idioms are the secret to sounding native. Today, we look at idioms inspired by the weather.|||Elo: Weather idioms are used even when we aren't talking about the weather. Ready?",
        "VOCAB|||Atmospheric Expressions|||Key weather-related idioms:\n\n*   **Under the weather** - Feeling sick or unwell.\n*   **Take a rain check** - Politely postpone an invitation to a later date.\n*   **On cloud nine** - Feeling extremely happy and excited.\n*   **Steal someone's thunder** - Take attention away from someone else's achievements.|||Elo: If a coworker took credit for your project, did they 'steal your thunder'?",
    ...
    "idm-02": {
      ...
      title: "Sports Idioms",
      slides: [
        "INTRO|||Get in the Game|||American English is packed with idioms from baseball, football, and boxing. Let's learn sports idioms.|||Elo: Do you play or watch any sports?",
        "VOCAB|||The Game Changers|||Essential sports idioms in business and life:\n\n*   **Ball is in your court** - It is your responsibility to make the next move.\n*   **Touch base** - Briefly contact someone to update them.\n*   **Drop the ball** - Make a mistake or fail in a duty.\n*   **Blow me away** - Impress someone greatly.|||Elo: If you forgot to send a client an email, did you 'drop the ball'?",
    ...
    "idm-03": {
      ...
      slides: [
        "INTRO|||Daily Chunks|||Let's wrap up with the most common, everyday idioms that Americans use at home, work, and school.|||Elo: Master these and you will sound like you lived in the US for years.",
        "VOCAB|||Everyday Classics|||Common idioms for daily life:\n\n*   **Bite the bullet** - Face a difficult situation with courage.\n*   **Break a leg** - Good luck (used especially in theater/performances).\n*   **Call it a day** - Stop working on something for the rest of the day.\n*   **Go back to the drawing board** - Start over because a previous attempt failed.|||Elo: If your project fails and you have to start from scratch, where do you go?",
  ...
  "movies-tv-culture": {
    "mov-01": {
      id: "mov-01",
      title: "Streaming Culture & Binge-Watching",
      slides: [
        "INTRO|||Netflix and Chill?|||Welcome to Movies & TV! Today, we discuss how streaming platforms have transformed our social lives and language.|||Elo: Hello! What was the last series you binge-watched?",
        "VOCAB|||Streaming Vocabulary|||Key terms for the digital era:\n\n*   **Binge-watch** - Watch multiple episodes of a show in rapid succession.\n*   **Cliffhanger** - A dramatic ending to an episode that leaves you wanting more.\n*   **Spoiler** - Information that reveals plot points and ruins the surprise.\n*   **Hype / Hyped** - Intense promotion and excitement surrounding a release.|||Elo: Do you get angry when someone gives you a 'spoiler' about a show?",
    ...
    "mov-02": {
      id: "mov-02",
      title: "Movie Genres, Plots & Story Tropes",
      slides: [
        "INTRO|||Inside the Script|||Let's dissect what makes a movie work: genres, plots, twists, and common story tropes.|||Elo: What is your favorite film genre? Sci-fi, drama, comedy, or thriller?",
        "VOCAB|||Cinema Terminology|||Useful terms for film analysis:\n\n*   **Plot twist** - An unexpected development in a story.\n*   **Trope / Cliché** - A common or overused theme/device in movies.\n*   **Underdog** - A competitor thought to have little chance of winning.\n*   **Box office hit** - A highly successful commercial movie.|||Elo: What is your favorite movie 'plot twist' of all time?",
    ...
    "mov-03": {
      id: "mov-03",
      title: "Writing Reviews & Critical Vocabulary",
      slides: [
        "INTRO|||The Critic's Desk|||To talk about movies professionally, we need critical vocabulary. Let's learn to write reviews.|||Elo: Do you read movie reviews before watching a film?",
        "VOCAB|||Critical Adjectives|||Terms for describing cinema quality:\n\n*   **Thought-provoking** - Stimulating interest or making you think.\n*   **Gory** - Involving a lot of violence and blood.\n*   **Cheesy / Corny** - Cheap, silly, or overly sentimental.\n*   **Overrated** - Rated more highly than it deserves.|||Elo: Can you name a movie that you think is extremely overrated?",
    ...
    "mov-04": {
      id: "mov-04",
      title: "The Business of Hollywood & Streaming Wars",
      slides: [
        "INTRO|||Behind the Scenes|||Let's discuss the business side of entertainment: budgets, franchises, streaming algorithms, and industry battles.|||Elo: Which streaming service do you think has the best original content?",
        "VOCAB|||Industry & Production|||Key terms for the entertainment business:\n\n*   **Franchise** - A series of related media (e.g. Marvel Cinematic Universe).\n*   **Greenlight** - Give permission to go ahead with a project.\n*   **Niche** - A specialized segment of the market.\n*   **Subs / Subscribers** - Customers who pay a recurring fee for a service.|||Elo: Do you think Hollywood relies too much on existing franchises?",
  ...
  "music-lyrics-culture": {
    "mus-01": {
      id: "mus-01",
      title: "Talking Genres, Tempos & Musical Taste",
      slides: [
        "INTRO|||The Universal Language|||Welcome to Music! Today, we explore how to talk about genres, rhythms, lyrics, and our musical tastes.|||Elo: Hello! What genre of music do you listen to when you need to focus?",
        "VOCAB|||Musical Terms|||Vocabulary for describing music:\n\n*   **Genre** - A category of artistic composition (e.g. Rock, Jazz, Hip Hop).\n*   **Catchy** - Instantly appealing and memorable (e.g. 'a catchy hook').\n*   **Beat / Tempo** - The rhythm and speed of a piece of music.\n*   **Acoustic** - Music produced without electrical amplification.|||Elo: What is the catchiest song you know?",
    ...
    "mus-02": {
      id: "mus-02",
      title: "Analyzing Idioms in Song Lyrics",
      slides: [
        "INTRO|||Poetry in Motion|||Song lyrics are full of idioms, slang, and cultural metaphors. Let's analyze how pop stars write.|||Elo: Can you think of an English song lyric that you never fully understood?",
        "VOCAB|||Lyrical Devices|||Terms for poetic devices in songs:\n\n*   **Rhyme scheme** - The ordered pattern of rhymes at the ends of lines.\n*   **Slang** - Informal language specific to a group or culture.\n*   **Metaphor** - A figure of speech applying a word to something it doesn't literally denote.\n*   **Hook** - The catchy, repetitive part of a song that gets stuck in your head.|||Elo: What is your favorite song hook of all time?",
    ...
    "mus-03": {
      id: "mus-03",
      title: "Concerts, Festivals & Live Events",
      slides: [
        "INTRO|||The Live Experience|||There is nothing like live music. Let's learn to talk about concert venues, festivals, and crowds.|||Elo: Have you ever been to a major music festival like Rock in Rio or Coachella?",
        "VOCAB|||Live Music Terms|||Vocabulary for concerts and events:\n\n*   **Venue** - The place where an event is held (e.g. stadium, club).\n*   **Lineup** - The list of artists performing at a festival.\n*   **Headliner** - The main artist or band performing at a concert.\n*   **Gig** - A single performance or job by a musician.|||Elo: Who was the best headliner you've ever seen live?",
    ...
    "mus-04": {
      id: "mus-04",
      title: "Music Production, Streaming & Global Influence",
      slides: [
        "INTRO|||The Digital Sound|||Let's discuss how Spotify, algorithms, and digital production have reshaped how music is made and consumed.|||Elo: Do you use Spotify, Apple Music, or YouTube to stream your music?",
        "VOCAB|||Industry & Production|||Key terms for the modern music economy:\n\n*   **Royalties** - Payments made to artists for the use of their music.\n*   **To stream / Streaming** - Transmit data as a continuous flow over the internet.\n*   **Track** - A single song or recording.\n*   **Producer** - The person who oversees and manages the recording of music.|||Elo: Do you think streaming services pay artists enough royalties?",
