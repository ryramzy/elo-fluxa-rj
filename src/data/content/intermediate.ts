export const intermediateContent: Record<string, Record<string, { id: string; title: string; slides: string[] }>> = {
  "intermediate-english-topics": {
    "int-tc-01": {
      ...
      slides: [
        "INTRO|||Speak Your Mind|||Welcome to the Intermediate level. It's time to start sharing what you really think.|||Elo: Are you someone who loves to debate, or do you prefer to keep the peace?",
        ...
        "REVIEW|||Diplomat Status|||You learned: Softening disagreements and expressing opinions professionally.|||Elo: That's the shift. You are ready to hold your own in any discussion."
      ]
    },
    "int-tc-02": {
      id: "int-tc-02",
      ...
      slides: [
        "INTRO|||Let Me Tell You A Story...|||Being a good storyteller is a valuable skill. Let's learn how to tell engaging stories in English.|||Elo: What's the craziest thing that's ever happened to you on a trip?",
        ...
        "CULTURE|||Exaggeration|||Americans love hyperbole in storytelling. 'It was the best thing ever', 'I literally died laughing'.|||Elo: 'Literally' is often used figuratively now.",
        ...
        "REVIEW|||Master Storyteller|||You learned: Narrative tenses, flow words, and cultural hyperbole.|||Elo: Book a session with me and tell me the full version."
      ]
    },
    "int-tc-03": {
      id: "int-tc-03",
      ...
      slides: [
        ...
        "VOCAB|||Future Certainty|||Definitely, Probably, Might/May, Probably not, Definitely not.|||Elo: Where do you put 'probably'? Before or after the verb?",
        "CONCEPT|||Will vs Going To (Review)|||Use 'Will' for spontaneous decisions or predictions. Use 'Going to' for planned actions.|||Elo: If I drop my pen, will you say 'I will pick it up' or 'I am going to pick it up'?",
        ...
        "REVIEW|||Future Ready|||You learned: Adverbs of certainty, will vs going to, and making predictions.|||Elo: You have a solid grasp of future tenses now."
      ]
    },
    "int-tc-04": {
      id: "int-tc-04",
      ...
      slides: [
        ...
        "CULTURE|||Solution-Oriented Culture|||American business culture avoids complaining without solutions. Always bring a 'workaround' when presenting a problem.|||Elo: Be a problem-solver, not just a problem-finder.",
        "DRILL|||Translation|||Translate: 'Se eu fosse você, eu falaria com o chefe.'|||Elo: Use the 2nd conditional structure we learned.",
        "ROLEPLAY|||The Broken Laptop|||Your colleague's laptop just crashed right before a big presentation.|||Elo: Suggest a quick workaround. Use 'Have you thought about...'",
        "REVIEW|||Problem Solver|||You learned: Brainstorming verbs, giving polite advice, and solution-culture.|||Elo: Problem sorted. Let's move on to the next challenge."
      ]
    },
    "int-tc-05": {
      id: "int-tc-05",
    ...
    "int-tc-06": {
      ...
      slides: [
        "INTRO|||Breaking News|||Discussing current events requires specific vocabulary and tact.|||Elo: Do you read the news daily, or try to avoid it for your mental health?",
        "VOCAB|||Headlines|||To claim, To urge, To back, A breakthrough, A setback.|||Elo: News headlines use short words. 'To back' means to support.",
        ...
        "EXAMPLE|||The Discussion|||A: Did you see the news about the new tax bill? — B: Yeah, it seems like it might cause some controversy.|||Elo: Notice the diplomatic approach from B.",
        ...
        "REVIEW|||Diplomat Ready|||You learned: News verbs, hedging techniques, and conversation taboos.|||Elo: You did the work. You've completed the Intermediate Conversation module."
      ]
    }
  },
  "english-grammar-beginner": {
    "gr-beg-01": {
      ...
      slides: [
        "INTRO|||The Present Simple|||This is the foundation of English. We use it for facts, habits, and routines.|||Elo: Let's master the foundation.",
        "CONCEPT|||The 'S' Rule|||I work, You work, We work, They work. BUT: He works, She works, It works. Add 's' for the 3rd person singular.|||Elo: This is a common error. Remember the 's'.",
        "EXAMPLE|||Daily Routine|||'I wake up at 7 AM. My brother wakes up at 8 AM.'|||Elo: Notice the difference. Wake vs Wakes.",
        ...
        "REVIEW|||Solid Foundation|||You learned: The 's' rule, do/does, and adverbs of frequency.|||Elo: You did the work. The foundation is solid."
      ]
    },
    "gr-beg-02": {
      id: "gr-beg-02",
      ...
      slides: [
        "INTRO|||To Be or Not To Be|||Ser ou estar. It's the most irregular verb in English, but the most important.|||Elo: Let's conquer the verb To Be.",
        ...
        "REVIEW|||Being Awesome|||You learned: To be conjugation, age rules, and question structure.|||Elo: Try it again — this time notice how natural the contractions sound."
      ]
    },
    "gr-beg-03": {
      id: "gr-beg-03",
      ...
      slides: [
        "INTRO|||The Little Words|||A, An, The. They are tiny, but they cause massive confusion for Portuguese speakers.|||Elo: Let's fix the guesswork.",
        ...
        "CULTURE|||Names and Titles|||We don't use 'The' before names. Never say 'The John is here'. Just 'John is here'.|||Elo: Pay attention not to put 'The' in front of your friends' names.",
        ...
        "REVIEW|||Article Master|||You learned: A/An sounds, specific vs general, and the zero article rule.|||Elo: You did the work. Keep practicing the zero article rule."
      ]
    },
    "gr-beg-04": {
      id: "gr-beg-04",
      ...
      slides: [
        "INTRO|||One or Many?|||Adding 's' is usually enough, but English loves exceptions. Let's look at plurals.|||Elo: Let's review how to multiply nouns.",
        ...
        "CONCEPT|||Irregular Plurals|||Man -> Men, Woman -> Women, Child -> Children, Person -> People, Tooth -> Teeth, Mouse -> Mice.|||Elo: Don't say 'persons' or 'childs'. It's a noticeable mistake.",
        ...
        "REVIEW|||Plural Perfection|||You learned: -es endings, irregular plurals, and uncountable nouns like advice and information.|||Elo: You did the work. You're building a strong base."
      ]
    },
    "gr-beg-05": {
      id: "gr-beg-05",
      ...
      slides: [
        ...
        "REVIEW|||You Own It|||You learned: Subject vs Object, possessive adjectives, and possessive pronouns.|||Elo: You did the work. You've completed Beginner Grammar."
      ]
    }
  },
  "english-grammar-high-beginner": {
    "gr-hbeg-01": {
      ...
      slides: [
        ...
        "CONCEPT|||The -ED Ending|||For regular verbs, just add -ed. Play -> Played. Work -> Worked. Walk -> Walked.|||Elo: Sounds simple, but the pronunciation is the tricky part.",
        ...
        "CULTURE|||Weekend Catch-up|||'What did you do this weekend?' is the most common Monday morning question in the US.|||Elo: You will use the past simple every Monday.",
        ...
        "REVIEW|||Past Perfected|||You learned: -ED endings, pronunciation tricks, and did/didn't.|||Elo: That's the shift. Notice how natural the past tense feels now."
      ]
    },
    "gr-hbeg-02": {
      id: "gr-hbeg-02",
    ...
    "gr-hbeg-03": {
      ...
      slides: [
        ...
        "DRILL|||Translation|||Translate: 'Tem muitas pessoas na sala, mas não tem comida.'|||Elo: Use 'There are' and 'There isn't'.",
    ...
    "gr-hbeg-04": {
      ...
      slides: [
        "INTRO|||In, On, At|||Prepositions are tricky, but there is a logic to them. Let's learn the triangle.|||Elo: Prepositions take time. Let's map them out.",
        ...
        "DRILL|||Translation|||Translate: 'Meu aniversário é em Julho. A festa é no sábado às 8 da noite.'|||Elo: Apply the triangle rules: In July, On Saturday, At 8 PM.",
        "ROLEPLAY|||Scheduling a Call|||A client says: 'Can we meet next week?'|||Elo: Suggest meeting ON Tuesday AT 10 AM.",
        "REVIEW|||Preposition Pro|||You learned: The In/On/At triangle for time and place.|||Elo: Memorize the triangle and you'll be correct most of the time."
      ]
    },
    "gr-hbeg-05": {
      id: "gr-hbeg-05",
      ...
      slides: [
        ...
        "REVIEW|||Comparison Complete|||You learned: -er vs more, 'than', and irregular comparatives.|||Elo: You did the work. You are officially an intermediate."
      ]
    }
  },
  "english-grammar-intermediate": {
    ...
    "gr-int-02": {
      ...
      slides: [
        "INTRO|||Just, Already, and Yet|||The Present Perfect is also used for actions that happened recently and affect the present.|||Elo: 'I have just finished my coffee.' Let's learn these words.",
    ...
    "gr-int-03": {
      ...
      slides: [
        ...
        "CONCEPT|||Mustn't vs Don't have to|||CAREFUL. They are different. 'You mustn't go' = It's forbidden. 'You don't have to go' = It's optional, you choose.|||Elo: This is a common trap for Portuguese speakers.",
        ...
        "REVIEW|||Rule Master|||You learned: Have to (fact), Must (rule), Don't have to (choice), Mustn't (forbidden), Should (advice).|||Elo: You did the work. That's the shift."
      ]
    },
    "gr-int-04": {
      id: "gr-int-04",
      ...
      slides: [
        "INTRO|||If This, Then That|||Conditionals talk about cause and effect. Let's master the real and possible situations.|||Elo: Let's master the real and possible situations.",
    ...
    "gr-int-05": {
      ...
      slides: [
        ...
        "REVIEW|||Connection Made|||You learned: Who/Which/That, dropping the object pronoun, and comma rules.|||Elo: You did the work. Let's move to the next level."
      ]
    }
  },
  "english-grammar-advanced": {
    "gr-adv-01": {
      ...
      slides: [
        "INTRO|||Focus on the Action|||Sometimes who did the action isn't important. The action itself is. That's when we use the Passive Voice.|||Elo: 'Mistakes were made.' A classic phrase.",
        ...
        "REVIEW|||Passively Perfect|||You learned: Forming the passive, when to use it, and when to avoid it.|||Elo: You did the work. Notice how this reframes the sentence."
      ]
    },
    "gr-adv-02": {
      id: "gr-adv-02",
      ...
      slides: [
        ...
        "CONCEPT|||Pronouns and Time|||You also have to change pronouns and time words. 'I will do it tomorrow' -> 'She said SHE would do it THE NEXT DAY.'|||Elo: It requires focus, but it becomes automatic.",
        ...
        "REVIEW|||The Reporter|||You learned: Backshifting tenses, reporting questions, and Say vs Tell.|||Elo: You can now successfully navigate office reporting in English."
      ]
    },
    "gr-adv-03": {
      id: "gr-adv-03",
      ...
      slides: [
        ...
        "REVIEW|||Condition Expert|||You learned: Imaginary present (2nd), Past regrets (3rd), and mixed conditionals.|||Elo: You did the work. That's the shift."
      ]
    },
    "gr-adv-04": {
      id: "gr-adv-04",
      ...
      slides: [
        ...
        "EXAMPLE|||Not only... but also|||'Not only did she pass the exam, but she also got the highest grade.'|||Elo: Notice the 'did she pass' instead of 'she passed'. This sounds formal and impressive.",
        ...
        "REVIEW|||Dramatic Effect|||You learned: Negative inversion and cleft sentences for emphasis.|||Elo: You did the work. Not only did you learn it, but you applied it."
      ]
    },
    "gr-adv-05": {
      id: "gr-adv-05",
      ...
      slides: [
        "INTRO|||The Glue of English|||Advanced speakers don't just speak in isolated sentences. They link their ideas beautifully.|||Elo: Words like 'Moreover' and 'Nevertheless' show mastery.",
        ...
        "CULTURE|||Academic vs Spoken|||'Furthermore' and 'Therefore' are great for essays and formal emails. In casual speech, natives prefer 'Plus', 'Also', and 'So'.|||Elo: Use the right tone for the setting.",
        ...
        "REVIEW|||Fluency Achieved|||You learned: Advanced linking words for contrast, cause, and addition.|||Elo: You've completed the Grammar track. You put in the work, and it shows."
      ]
    }
  }
};
