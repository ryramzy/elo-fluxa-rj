...
export default function ApplyTutor() {
  ...
  // If already pending, show holding screen
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Conte um pouco sobre você, de onde é e sua experiência..."
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none min-h-[80px]" 
              placeholder="Ex: 2 anos no Cambly, certificado TEFL..."
            />
          </div>
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none" 
              placeholder="Ex: Seg a Sex, das 18h às 22h (BRT)"
            />
          </div>
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-black text-sm uppercase tracking-widest rounded-xl transition-all shadow-lg active:scale-95 disabled:opacity-50"
          >
