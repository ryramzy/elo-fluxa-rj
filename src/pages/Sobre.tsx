    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Sobre Professor</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
              Olá! Sou Professor, um professor nativo de inglês americano que encontrou um lar no Rio de Janeiro. 
