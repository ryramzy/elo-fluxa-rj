    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl opacity-90 mb-8">
            Real American English insights from Professor's experience teaching Brazilians
          </p>
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl opacity-90 mb-8">
            Receive weekly tips and practice directly with Professor on WhatsApp
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`${getWhatsAppLink('general')}&text=Hi%20Professor!%20I%20want%20to%20receive%20weekly%20English%20tips`}
              target="_blank"
              rel="noopener noreferrer"
