...
const Hero: React.FC<HeroProps> = ({ onScheduleClick }) => {
  ...
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] overflow-hidden bg-slate-900">
      ...
      {/* Background Image - Rio de Janeiro Skyline */}
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6 max-w-5xl mx-auto">
        <div className="animate-fade-in-up">
          <span className="inline-block text-xs md:text-sm font-semibold uppercase tracking-[0.3em] text-blue-400 mb-8 px-4 py-1 border border-blue-400/30 bg-blue-400/10 rounded-full">
            The Native Connection
          </span>
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif text-white leading-[0.9] mb-8">
          ...
          <p className="text-xl md:text-2xl text-slate-200 font-light leading-relaxed mb-12 max-w-2xl mx-auto">
            Inglês com americano nativo. Conectando você ao mundo com fluência, confiança e o estilo de vida carioca.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              onClick={handleWhatsAppClick}
              className="px-10 py-5 bg-blue-600 text-white rounded-none text-sm font-bold uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl inline-flex items-center gap-3"
            >
            ...
            <button 
              ...
              className="px-10 py-5 bg-white text-slate-900 rounded-none text-sm font-bold uppercase tracking-widest hover:bg-slate-100 transition-all shadow-xl"
            >
              Agenda Aula
            </button>
          </div>
