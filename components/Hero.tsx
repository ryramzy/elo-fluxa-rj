        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button 
              ...
              className="px-8 py-4 bg-[#22C55E] text-white text-sm font-bold uppercase tracking-[0.3em] hover:bg-[#16A34A] transition-all shadow-xl inline-flex items-center gap-2"
            >
          ...
          <p className="text-sm text-slate-300 font-light mt-4 text-center">
